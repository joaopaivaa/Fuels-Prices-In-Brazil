...
df_lpg = download_LPG(first_year_month = '2022-01', last_year_month = '2025-08')
df_lpg.to_parquet('bronze/LPG Prices.parquet', index=False, engine='pyarrow')

# Gasoline Ethanol Prices

df_gasoline_ethanol = download_Gasoline_Ethanol(first_year_month = '2022-01', last_year_month = '2025-08')
...
df_diesel_cng = download_Diesel_CNG(first_year_month = '2022-01', last_year_month = '2025-08')
