...
most_recent_average_price_fuel_type = average_price_fuel_type.iloc[0:6].reset_index(drop=True)
last_month_average_price_fuel_type = average_price_fuel_type.iloc[6:12].reset_index(drop=True)
